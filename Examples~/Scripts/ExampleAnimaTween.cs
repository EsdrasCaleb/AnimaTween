...
public class ExampleAnimaTween : MonoBehaviour
{
    ...
    void onCompleteText()
    {
        ...
        this.ATimeout(3.0f, () => 
        {
            ...
            textArea2.ATween("text", "Tweens control data and data controls your game...", textTweenDuration, Easing.Linear);
    ...
    void StartPhysicsSequence()
    {
        ...
        cube.ATween("localScale", new Vector3(0.5f, 1.5f, 0.8f), 2f, Easing.InOutSine, playback:Playback.LoopPingPong);
